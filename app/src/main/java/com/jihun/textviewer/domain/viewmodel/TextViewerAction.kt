...
sealed interface TextViewerAction {
    ...
    data class OpenHistoryEntry(val fileUri: String, val page: Int, val totalPages: Int, val pageSize: Int) : TextViewerAction
    ...
    data class SetVisualPageCount(val totalPages: Int) : TextViewerAction
